...
router.post('/api/add-rating/:news_id', usermiddleware.auth, newsController.add_rating);
router.post('/api/add-comment/:news_id', usermiddleware.auth, newsController.add_comment);

// Add delete route for news
